...
function _escapeTime(sample, options) {
  ...
  var _palette = options.loopPalette ? loopPalette(_palette2["default"][options.palette]) : _palette2["default"][options.palette]; //deafult to black unless we managed to rule this pixel out
